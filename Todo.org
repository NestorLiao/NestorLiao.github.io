...
C->Zig, Easy! Turst Me Bro.
Just Rewrite  In C(Zig)!

- *c*->libuv->node.js->bun-> *zig*, Cross-platform *asynchronous I/O*
  https://github.com/libuv/libuv

- gdb->gf/raddebugger, gui *debugger*

- progress, nvtop, process watcher
...
- rlwrap, wrapper that uses the GNU Readline library to allow the comfortable editing and recalling of keyboard input for other commands.
  https://github.com/hanslub42/rlwrap

- raygui, A simple and easy-to-use immediate-mode *gui* library
  https://github.com/raysan5/raygui

- c++, imgui, Bloat-free *gui* for C++ with minimal dependencies
  https://github.com/ocornut/imgui

- miniaudio, *Audio* playback and capture library written in C, in a *single source file*.
  https://github.com/mackron/miniaudio

- subprocess, *single header* process launching solution for C and C++
  https://github.com/sheredom/subprocess.h

- dr_libs, *Audio* decoding libraries for C/C++, each in a *single source file* .
  https://github.com/mackron/dr_libs

- stb, *image* process, *single-file* public domain (or MIT licensed) libraries for C/C++
  https://github.com/nothings/stb

- c->zig build, *Header only library* for writing build recipes in C.
...
- c, but *better*
  ...
  d, v, c++, odain, jai, ..
- c->java/zig,  build-once run-anywhere
  https://github.com/jart/cosmopolitan
- c->rust memory safty, a fanatically compatible memory-safe implementation of C and C++.
  https://github.com/pizlonator/fil-c
- c->go routine, Libmill is a library that introduces Go-style concurrency to C.
